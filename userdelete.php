...
<html>
	...
	<body align="center">
		<form method="post" action="Validation/userdeletecheck.php">
				...
				<table border="0" width="30%" align="center">	
					<tr>
						<td height="300" width="300" colspan="2"><img src="<?=$row['image_masterbed']?>" alt="Server Image" height="250px" width="250px"/></td>
					</tr>
					<tr>
